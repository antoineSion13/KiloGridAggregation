...
ax = sns.histplot(data=dataNonInformed, x="black", y="white", cbar = True, binwidth = 2.5/2, color = "gray", vmax = 10)
...
# 				dataNonInformedTime[2][i-1].append(20 - int(row[1]) - int(row[2]))
# 			lineCount += 1
